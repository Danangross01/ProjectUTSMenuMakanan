...
public class Detail_Makanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_namaM = findViewById(R.id.txt_namaMakanan);
        txt_descM = findViewById(R.id.txt_descMakanan);
        txt_hargaM = findViewById(R.id.txt_hargaMakanan);
        img_gambarM = findViewById(R.id.img_gambarMakanan);
